...
const conversationA: Message[] = [
  ...
  },
  {
    ...
    from: "bot",
    type: "text",
    text: "Found 8 notes across #memory #ml #cognitive-science. Your notes trace an arc: biological memory \u2192 spaced repetition \u2192 vector retrieval \u2192 the paper you just saved. Want me to draft a synthesis?",
    time: "10:35",
    delay: 7000,
    typing: 2200,
  },
...
const conversationB: Message[] = [
  {
    ...
    from: "user",
    type: "text",
    text: "how was my mood in December?",
    time: "21:14",
    delay: 0,
    typing: 0,
  },
  {
    ...
    from: "bot",
    type: "text",
    text: "Looking at your December notes and journal entries...",
    time: "21:14",
    delay: 600,
    typing: 1400,
  },
  {
    ...
    from: "bot",
    type: "text",
    text: "Early December was intense \u2014 lots of notes about deadline pressure and late nights. Around the 15th things shifted: you started journaling about taking walks, cooking again, and a trip to the coast.",
    time: "21:14",
    delay: 2400,
    typing: 1600,
  },
  {
    ...
    from: "user",
    type: "text",
    text: "write a short reflection about that",
    time: "21:15",
    delay: 4800,
    typing: 0,
  },
  {
    ...
    from: "bot",
    type: "text",
    text: "Here\u2019s a draft in your voice:\n\n\u201CDecember taught me something I keep forgetting: burnout doesn\u2019t announce itself. It creeps in as one more late night, one more skipped meal. The turning point wasn\u2019t dramatic \u2014 just a Tuesday walk where I noticed the sky.\u201D\n\nWant me to save this as a note?",
    time: "21:15",
    delay: 5600,
    typing: 2400,
  },
...
function ChatBubble({ message }: { message: Message }) {
  ...
  return (
    ...
    >
      <div
        className={`relative max-w-[80%] rounded-2xl px-3.5 py-2 text-[12px] leading-[1.45] ${
          isUser
      ...
      >
        {message.type === "voice" ? (
          <div className="flex items-center gap-2.5">
            ...
            <VoiceWaveform />
            <span className="ml-1 shrink-0 text-[11px] text-white/60">
              0:12
            </span>
          </div>
        ) : message.type === "link" ? (
...
function useConversationAnimation(
  ...
  }, [isInView, conversation]);

  return { visibleMessages, showTyping };
}
...
function PhoneFrame({
  ...
  const { visibleMessages, showTyping } = useConversationAnimation(
    conversation,
    isInView
  );
  ...
  return (
    ...
    >
      ...
      {/* Phone frame */}
      <div className="reflection-wrap reflection-wrap-phone">
      <div className="relative overflow-hidden rounded-[2.5rem] border border-zinc-200/80 bg-zinc-100 p-1 shadow-2xl shadow-zinc-300/40">
        ...
        <div className="overflow-hidden rounded-[2rem] bg-[#E8E2D9]">
          ...
          {/* Messages area */}
          <div className="flex h-[610px] flex-col gap-1.5 overflow-hidden px-2 py-2.5">
            {conversation
...
export function TelegramDemo() {
  ...
  return (
    <section ref={ref} className="mx-auto w-full max-w-5xl px-6 py-16">
      <motion.div
